...
#
# Generated by export_simulation on Sat Mar 26 08:22:57 UTC 2022
#
################################################################################
...
'-reset_run' switch to the './AXIcrossbar1.sh' script.

./AXIcrossbar1.sh -reset_run
...
./AXIcrossbar1.sh -noclean_files

For more information on the script, please type './AXIcrossbar1.sh -help'.
