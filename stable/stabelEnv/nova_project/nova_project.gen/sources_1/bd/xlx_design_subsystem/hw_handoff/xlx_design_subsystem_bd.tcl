...
proc create_root_design { parentCell } {
  ...
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces hydra_m] [get_bd_addr_segs DDR_s/Reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces MTMLAddr_m] [get_bd_addr_segs DDR_s/Reg] -force
  ...
  assign_bd_address -offset 0x81000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces hydra_m] [get_bd_addr_segs xbar1/Reg] -force
  assign_bd_address -offset 0x81000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces MTMLAddr_m] [get_bd_addr_segs xbar1/Reg] -force
