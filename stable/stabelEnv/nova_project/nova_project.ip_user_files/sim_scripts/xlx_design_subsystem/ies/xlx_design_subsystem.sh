...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.xlx_design_subsystem \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../nova_project.gen/sources_1/bd/xlx_design_subsystem/ipshared/ec67/hdl" \
       +incdir+"../../../../nova_project.gen/sources_1/bd/xlx_design_subsystem/ipshared/ec67/hdl"
}
