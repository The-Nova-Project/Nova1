...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net DDR_ADDR_512_64_1 [get_bd_intf_ports DDR_ADDR_512_64] [get_bd_intf_pins axi_crossbar_3/S01_AXI]
  ...
  connect_bd_net -net aclk_0_1 [get_bd_ports aclk_0] [get_bd_pins axi_crossbar_2/aclk] [get_bd_pins axi_crossbar_3/aclk] [get_bd_pins axi_dwidth_converter_1/s_axi_aclk] [get_bd_pins axi_protocol_convert_0/aclk] [get_bd_pins axi_uartlite_1/s_axi_aclk]
  connect_bd_net -net aresetn_0_1 [get_bd_ports aresetn_0] [get_bd_pins axi_crossbar_2/aresetn] [get_bd_pins axi_crossbar_3/aresetn] [get_bd_pins axi_dwidth_converter_1/s_axi_aresetn] [get_bd_pins axi_protocol_convert_0/aresetn] [get_bd_pins axi_uartlite_1/s_axi_aresetn]
